            ...
            <div className={styles.grid}>
                <div className={styles.card}>
                    ...
                    <p className={styles.subtitle}>
                        Total including ${cash.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })} cash
                    </p>
                </div>
                ...
                <div className={styles.card}>
                    <div className={styles.cardHeader}>
                        ...
                        {monthlyReturn >= 0 ? <TrendingUp size={20} color="#22c55e" /> : <TrendingDown size={20} color="#ef4444" />}
                    </div>
                                ...
                                {topHoldings.map((pos) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className={styles.textRight}>{pos.shares}</td>
                                            <td className={styles.textRight}>
                                                ${(pos.marketValue || 0).toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                            </td>
                                            <td
                                                className={styles.textRight}
                                                style={{ color: isPositive ? "#22c55e" : "#ef4444", fontWeight: 500 }}
                                            >
            ...
            <div className={styles.layout}>
                ...
                <div className={styles.card} style={{ gridColumn: "1 / -1" }}>
                    <div className={styles.chartHeader}>
                        <h3 style={{ margin: 0, fontSize: "0.95rem", fontWeight: 600, color: "var(--text-secondary)", textTransform: "uppercase", letterSpacing: "0.05em" }}>Portfolio Value Over Time</h3>
                        ...
                        <div className={styles.moversGrid}>
                            <div className={styles.moverSection}>
                                ...
                                {topGainers.map(stock => (
                                    <div key={stock.symbol} className={styles.moverItem} onClick={() => navigate(`/stocks/${stock.symbol}`)} style={{ cursor: 'pointer' }}>
                                        <div>
                                            <div className={styles.moverSymbol}>{stock.symbol}</div>
                                            <div className={styles.moverPrice}>${Number(stock.currentPrice ?? 0).toFixed(2)}</div>
                                        </div>
                                ...
                                <div key={trade.id} className={styles.transactionItem}>
                                    <div className={styles.txInfo}>
                                        <div
                                            ...
                                            style={{
                                                background: trade.side === "BUY" ? "rgba(239, 68, 68, 0.1)" : "rgba(34, 197, 94, 0.1)",
                                    ...
                                    >
                                        {trade.side === "BUY" ? "-" : "+"}${trade.total.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                    </span>
                                </div>
                            ))}
                        </div>
